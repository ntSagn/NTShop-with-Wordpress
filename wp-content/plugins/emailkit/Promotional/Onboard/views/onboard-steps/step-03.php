...
<div class="emailkit-onboard-pagination">
    ...
    <a class="emailkit-onboard-btn emailkit-onboard-pagi-btn next" data-plugin_status="<?php echo esc_attr($plugin['status']); ?>" data-activation_url="<?php echo esc_url($plugin['activation_url']) ?>" href="#"><?php echo esc_html__('Next Step', 'emailkit'); ?></a>
</div>
