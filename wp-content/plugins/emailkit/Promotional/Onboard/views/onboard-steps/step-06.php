<div class="emailkit-onboard-main-header">
    ...
    <p class="emailkit-onboard-main-header--description"><?php echo esc_html__('You\'re in!
Start Upgrading Your Emails in WordPress with the Best Email Customizer!', 'emailkit'); ?></p>
